...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	// Query records that have usernames and passwords that match those in the owner table
	...
	if(!empty($users)) {
		...
		// Set a session variable with a key of ownerID equal to the ownerID returned
